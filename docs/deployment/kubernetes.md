...
OpenFaaS is Kubernetes-native and uses _Deployments_, _Services_ and _Secrets_. For more detail check out the ["faas-netes" repository](https://github.com/openfaas/faas-netes).
...
- Deploy the whole stack
  ...
  !!! note
  For deploying on a cloud that supports Kubernetes _LoadBalancers_ you may also want to apply the configuration in: `cloud/lb.yml`.
